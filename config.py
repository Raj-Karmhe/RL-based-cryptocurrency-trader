...
# Model checkpoint
MODEL_NAME   = "clstm_ppo_strategy_2_with_exit_corrected_with_fees"
...
MIN_POSITION_CHANGE     = 0.20       # Minimum change in target_position required to trigger a trade
...
HOLDING_INCENTIVE       = 0.0001      # Small reward added for holding a long position to counteract short bias
